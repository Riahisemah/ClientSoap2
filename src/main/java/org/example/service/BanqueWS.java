 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://Service.example.org/", wsdlLocation = "http://localhost:8082/untitled/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8082/untitled/BanqueWS?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://Service.example.org/", "Banque_ServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Service.example.org/", "Banque_ServicePort"), BanqueService.class, features);
    }
